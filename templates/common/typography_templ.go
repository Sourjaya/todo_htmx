...
func Typography(variant string, label string, classNames string) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if variant == "header" {
			var templ_7745c5c3_Var2 = []any{"text-white font-exo2 text-5xl", classNames}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/common/typography.templ`, Line: 1, Col: 0}
			}
			...
			var templ_7745c5c3_Var5 = []any{"text-black font-exo2 text-sm", classNames}
